...
describe("About Higher Order Functions", function () {
  ...
  it("should use 'all' to test whether all items pass condition", function () {
    var onlyEven = [2,4,6]; //do I copy this from the bottom?
    var mixedBag = [2,4,5,6]; //do I copy this from the bottom?

    var isEven = function(x) { return x % 2 === 0 } //do I copy this from the bottom?
  ...
  it("should use range to generate an array", function() {
    expect(_.range(3)).toEqual([0, 1, 2]); //indexes
    expect(_.range(1, 4)).toEqual([1, 2, 3]); //indexes
    expect(_.range(0, -4, -1)).toEqual([0, -1, -2, -3]); //look over this
  });
